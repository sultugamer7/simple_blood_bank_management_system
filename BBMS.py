...
def newdonor():
    ...
    def sel1():
        ...
        if(not(ndl8.cget("text")!="")):
            ...
            v3.config(text="")
    var1 = StringVar()
    ndr1=Radiobutton(nd,text="Male",variable=var1,value="Male",command=sel1,bg="#FCFF33")
    ndr1.place(x=120,y=133)
    ndr2=Radiobutton(nd,text="Female",variable=var1,value="Female",command=sel1,bg="#FCFF33")
    ...
    def sel2():
        ...
        if(not(ndl9.cget("text")!="")):
            ...
            v5.config(text="")
    var2 = StringVar()
    ndr3=Radiobutton(nd,text="A",variable=var2,value="A",command=sel2,bg="#FCFF33")
    ndr3.place(x=120,y=213)
    ndr4=Radiobutton(nd,text="B",variable=var2,value="B",command=sel2,bg="#FCFF33")
    ndr4.place(x=155,y=213)
    ndr5=Radiobutton(nd,text="AB",variable=var2,value="AB",command=sel2,bg="#FCFF33")
    ndr5.place(x=190,y=213)
    ndr1=Radiobutton(nd,text="O",variable=var2,value="O",command=sel2,bg="#FCFF33")
    ...
    def sub():
        ...
        if((not(nde1.get() and nde2.get() and nde3.get() and ndl8.cget("text")!="" and ndl9.cget("text")!="")) or (not(mo1 and mo2 and mo3))):
            if(not(nde1.get())):
                v1.config(text="Name required!")
            elif(not(mo1)):
                v1.config(text="Valid name required!")
            ...
            v4.config(text="")
            v5.config(text="")
            answer=messagebox.askquestion("Submit","Are you sure?",icon='warning',parent=nd)
            if(answer=='yes'):
                conn = sqlite3.connect('test.db')
                c = conn.cursor()
                sql="INSERT INTO DonorInfo(dname,age,dgender,dcity,dbldgrp,date) VALUES('"+a+"',"+b+",'"+d+"','"+f+"','"+e+"',date('now'))"
                try:
                    c.execute(sql)
    ...
    ndb1=Button(nd,text="SUBMIT",font='helvetica',height=1,width=15,command=sub,bg='#FF3232',fg='#FCFF33')
    ndb1.place(x=40,y=290)

    def cancel():
        nd.destroy()
    ndb2=Button(nd,text="CANCEL",font='helvetica',height=1,width=15,command=cancel,bg='#FF3232',fg='#FCFF33')
...
def dlist():
    ...
    if(not(result)):
        ...
        try:
            ...
            messagebox.showerror("Error","Unable to show donor's information!",parent=dl)
    conn.commit()
    c.close()
    conn.close()
...
def searchdonor():
    ...
    if(not(result)):
        ...
        labelfont = ('times', 30, 'bold')
        l1=Label(sd,text="Search Donor By : ",font=labelfont,bg="black",fg="white")
        l1.place(x=330,y=10)
        ...
        def sel():
            ...
            if(radval=="dno"):
                ...
                dnol1=Label(dno,text="Enter Donor Number  : ",font='helvetica',fg="white",bg="black")
                ...
                def search():
                    ...
                    if(not(dnoe1.get()) or not(mo1)):
                        ...
                        v.config(text="")
                        answer=messagebox.askquestion("Search","Are you sure?",icon='warning',parent=dno)
                        if(answer=='yes'):
                            conn = sqlite3.connect('test.db')
                            c = conn.cursor()
                            ...
                            try:
                                ...
                                result=c.fetchall()
                                if(not(result)):
                                    messagebox.showerror("Error","Donor having Donor Number : "+a+" is not in the Donors List!",parent=dno)
                                else:
                                    ...
                                    dlf1=LabelFrame(dl,text="Number",font='helvetica',bg="black",fg="white")
                                    dlf1.grid(row=1,column=1,pady=5)
                                    dlf2=LabelFrame(dl,text="Name",font='helvetica',bg="black",fg="white")
                                    dlf2.grid(row=1,column=2,pady=5)
                                    dlf3=LabelFrame(dl,text="Age",font='helvetica',bg="black",fg="white")
                                    dlf3.grid(row=1,column=3,pady=5)
                                    dlf4=LabelFrame(dl,text="Gender",font='helvetica',bg="black",fg="white")
                                    dlf4.grid(row=1,column=4,pady=5)
                                    dlf5=LabelFrame(dl,text="City",font='helvetica',bg="black",fg="white")
                                    dlf5.grid(row=1,column=5,pady=5)
                                    dlf6=LabelFrame(dl,text="Blood Group",font='helvetica',bg="black",fg="white")
                                    dlf6.grid(row=1,column=6,pady=5)
                                    dlf7=LabelFrame(dl,text="Donated Date",font='helvetica',bg="black",fg="white")
                                    dlf7.grid(row=1,column=7,pady=5)
                                    try:
                                        for row in result:
                                            v1=row[0]
                                            ...
                                            v6=row[5]
                                            v7=row[6]
                                            dl1=Label(dlf1,text=v1,font='helvetica',bg="black",fg="white")
                                            dl1.pack()
                                            dl2=Label(dlf2,text=v2,font='helvetica',bg="black",fg="white")
                                            dl2.pack()
                                            dl3=Label(dlf3,text=v3,font='helvetica',bg="black",fg="white")
                                            dl3.pack()
                                            dl4=Label(dlf4,text=v4,font='helvetica',bg="black",fg="white")
                                            dl4.pack()
                                            dl5=Label(dlf5,text=v5,font='helvetica',bg="black",fg="white")
                                            dl5.pack()
                                            dl6=Label(dlf6,text=v6,font='helvetica',bg="black",fg="white")
                                            dl6.pack()
                                            dl7=Label(dlf7,text=v7,font='helvetica',bg="black",fg="white")
                                            dl7.pack()
                                    except:
                                        messagebox.showerror("Error","Unable to show donor's information!",parent=dl)
                            finally:
                ...
                def canc():
                    dno.destroy()
                    sd.deiconify()
                dnob1=Button(dno,text="SEARCH",font='helvetica',height=1,width=10,command=search,bg="white",fg="black")
                dnob1.place(x=140,y=50)
                dnob2=Button(dno,text="CANCEL",font='helvetica',height=1,width=10,command=canc,bg="white",fg="black")
            ...
            if(radval=="dname"):
                ...
                dnamel1=Label(dname,text="Enter Donor's Name  : ",font='helvetica',fg="white",bg="black")
                ...
                def search():
                    ...
                    if(not(dnamee1.get()) or not(mo1)):
                        ...
                        v.config(text="")
                        answer=messagebox.askquestion("Search","Are you sure?",icon='warning',parent=dname)
                        if(answer=='yes'):
                            conn = sqlite3.connect('test.db')
                            c = conn.cursor()
                            ...
                            try:
                                ...
                                result=c.fetchall()
                                if(not(result)):
                                    messagebox.showerror("Error","Donor having name : "+a+" is not in the Donors List",parent=dname)
                                else:
                                    dl=Toplevel(root,bg="black")
                ...
                def canc():
                    dname.destroy()
                    sd.deiconify()
                dnameb1=Button(dname,text="SEARCH",font='helvetica',height=1,width=10,command=search,bg="white",fg="black")
                dnameb1.place(x=140,y=50)
                dnameb2=Button(dname,text="CANCEL",font='helvetica',height=1,width=10,command=canc,bg="white",fg="black")
            ...
            if(radval=="dage"):
                ...
                dagel1=Label(dage,text="Enter Donor's Age   : ",font='helvetica',fg="white",bg="black")
                ...
                def search():
                    ...
                    if(not(dagee1.get()) or not(mo1)):
                        ...
                        v.config(text="")
                        answer=messagebox.askquestion("Search","Are you sure?",icon='warning',parent=dage)
                        if(answer=='yes'):
                            conn = sqlite3.connect('test.db')
                            c = conn.cursor()
                            ...
                            try:
                                ...
                                result=c.fetchall()
                                if(not(result)):
                                    messagebox.showerror("Error","Donor having age : "+a+" is not in the Donors List",parent=dage)
                                else:
                                    dl=Toplevel(root,bg="black")
                ...
                def canc():
                    dage.destroy()
                    sd.deiconify()
                dageb1=Button(dage,text="SEARCH",font='helvetica',height=1,width=10,command=search,bg="white",fg="black")
                dageb1.place(x=140,y=50)
                dageb2=Button(dage,text="CANCEL",font='helvetica',height=1,width=10,command=canc,bg="white",fg="black")
            ...
            if(radval=="dbg"):
                ...
                dbgl1=Label(dbg,text="Select a Blood Group :",font=labelfont,bg="black",fg="white")
                ...
                def dbgsel():
                    ...
                    try:
                        ...
                        result=c.fetchall()
                        if(not(result)):
                            messagebox.showerror("Error","Donor having blood group : "+dbgradval+" is not in the Donors List",parent=dbg)
                        else:
                            dl=Toplevel(root,bg="black")
                ...
                dbgr1=Radiobutton(dbg,text="A",variable=dbgvar1,value="A",font=dbgradiofont,command=dbgsel,bg="black",fg="white")
                dbgr1.place(x=10,y=40)
                dbgr2=Radiobutton(dbg,text="B",variable=dbgvar1,value="B",font=dbgradiofont,command=dbgsel,bg="black",fg="white")
                dbgr2.place(x=10,y=80)
                dbgr3=Radiobutton(dbg,text="AB",variable=dbgvar1,value="AB",font=dbgradiofont,command=dbgsel,bg="black",fg="white")
                dbgr3.place(x=10,y=120)
                dbgr4=Radiobutton(dbg,text="O",variable=dbgvar1,value="O",font=dbgradiofont,command=dbgsel,bg="black",fg="white")
                dbgr4.place(x=10,y=160)
                def dbgcanc():
                    dbg.destroy()
                    sd.deiconify()
                dbgb1=Button(dbg,text="CANCEL",font='helvetica',height=1,width=10,command=dbgcanc,bg="white",fg="black")
                dbgb1.place(x=10,y=200)
                dbgvar1.set(" ")
            
        var1 = StringVar()
        radiofont = ('helvetica',15,'bold')
        r1=Radiobutton(sd,text="Donor Number",variable=var1,value="dno",font=radiofont,command=sel,bg="black",fg="white")
        r1.place(x=330,y=80)
        r2=Radiobutton(sd,text="Name",variable=var1,value="dname",font=radiofont,command=sel,bg="black",fg="white")
        r2.place(x=330,y=125)
        r3=Radiobutton(sd,text="Age",variable=var1,value="dage",font=radiofont,command=sel,bg="black",fg="white")
        r3.place(x=330,y=170)
        r4=Radiobutton(sd,text="Blood Group",variable=var1,value="dbg",font=radiofont,command=sel,bg="black",fg="white")
        ...
        def cancel():
            sd.destroy()
        b1=Button(sd,text="CANCEL",font='helvetica',height=1,width=10,command=cancel,bg="white",fg="black")
        ...
        if((not(nde1.get() and nde2.get() and nde3.get() and ndl8.cget("text")!="" and ndl9.cget("text")!="")) or (not(mo1 and mo2 and mo3))):
            ...
            if(answer=='yes'):
                ...
                try:
                    ...
                    q=res[0]
                    if(q==0):
                        messagebox.showerror("Error","Blood packet out of stock!",parent=nd)
                    else:
                        sql="INSERT INTO BuyerInfo(bname,age,bgender,bcity,bbldgrp,date) VALUES('"+a+"',"+b+",'"+d+"','"+f+"','"+e+"',date('now'))"
                        c.execute(sql)
                        messagebox.showinfo("Success","Buyer's details added!",parent=nd)
...
def blist():
    ...
    if(not(result)):
        ...
        try:
            ...
            messagebox.showerror("Error","Unable to show buyer's information!",parent=dl)
    conn.commit()
    c.close()
    conn.close()
...
def searchbuyer():
    ...
    if(not(result)):
        ...
        labelfont = ('times', 30, 'bold')
        l1=Label(sd,text="Search Buyer By : ",font=labelfont,bg="black",fg="white")
        l1.place(x=330,y=10)
        ...
        def sel():
            ...
            if(radval=="dno"):
                ...
                def delwin():
                    ...
                    dno.destroy()
                dno.protocol("WM_DELETE_WINDOW", delwin)
                dnol1=Label(dno,text="Enter Buyer Number  : ",font='helvetica',fg="white",bg="black")
                dnol1.place(x=10,y=10)
                v=Label(dno,font='helvetica',fg="red",bg="black")
                v.place(x=320,y=10)
                def checknum(cn):
                    ...
                    if(not(dnoe1.get()) or not(mo1)):
                        ...
                        if(answer=='yes'):
                            ...
                            try:
                                ...
                                result=c.fetchall()
                                if(not(result)):
                                    messagebox.showerror("Error","Buyer having Buyer Number : "+a+" is not in the Buyers List!",parent=dno)
                                else:
                                    dl=Toplevel(root,bg="black")
                                    ...
                                    dlf5=LabelFrame(dl,text="City",font='helvetica',bg="black",fg="white")
                                    dlf5.grid(row=1,column=5,pady=5)
                                    dlf6=LabelFrame(dl,text="Blood Packet",font='helvetica',bg="black",fg="white")
                                    dlf6.grid(row=1,column=6,pady=5)
                                    dlf7=LabelFrame(dl,text="Purchase Date",font='helvetica',bg="black",fg="white")
                                    dlf7.grid(row=1,column=7,pady=5)
                                    try:
                                        for row in result:
                                            v1=row[0]
            ...
            if(radval=="dname"):
                ...
                def delwin():
                    ...
                    dname.destroy()
                dname.protocol("WM_DELETE_WINDOW", delwin)
                dnamel1=Label(dname,text="Enter Buyer's Name  : ",font='helvetica',fg="white",bg="black")
                dnamel1.place(x=10,y=10)
                v=Label(dname,font='helvetica',fg="red",bg="black")
                v.place(x=320,y=10)
                def checknum(cn):
                    ...
                    if(not(dnamee1.get()) or not(mo1)):
                        ...
                        if(answer=='yes'):
                            ...
                            try:
                                ...
                                result=c.fetchall()
                                if(not(result)):
                                    messagebox.showerror("Error","Buyer having name : "+a+" is not in the Buyers List",parent=dname)
                                else:
                                    dl=Toplevel(root,bg="black")
            ...
            if(radval=="dage"):
                ...
                def delwin():
                    ...
                    dage.destroy()
                dage.protocol("WM_DELETE_WINDOW", delwin)
                dagel1=Label(dage,text="Enter Buyer's Age   : ",font='helvetica',fg="white",bg="black")
                dagel1.place(x=10,y=10)
                v=Label(dage,font='helvetica',fg="red",bg="black")
                v.place(x=320,y=10)
                def checknum(cn):
                    ...
                    if(not(dagee1.get()) or not(mo1)):
                        ...
                        if(answer=='yes'):
                            ...
                            try:
                                ...
                                result=c.fetchall()
                                if(not(result)):
                                    messagebox.showerror("Error","Buyer having age : "+a+" is not in the Buyers List",parent=dage)
                                else:
                                    dl=Toplevel(root,bg="black")
            ...
            if(radval=="dbg"):
                ...
                def dbgsel():
                    ...
                    try:
                        ...
                        result=c.fetchall()
                        if(not(result)):
                            messagebox.showerror("Error","Buyer having blood group : "+dbgradval+" is not in the Buyers List",parent=dbg)
                        else:
                            dl=Toplevel(root,bg="black")
        ...
        var1 = StringVar()
        radiofont = ('helvetica',15,'bold')
        r1=Radiobutton(sd,text="Buyer Number",variable=var1,value="dno",font=radiofont,command=sel,bg="black",fg="white")
        r1.place(x=330,y=80)
        r2=Radiobutton(sd,text="Name",variable=var1,value="dname",font=radiofont,command=sel,bg="black",fg="white")
        r2.place(x=330,y=125)
        r3=Radiobutton(sd,text="Age",variable=var1,value="dage",font=radiofont,command=sel,bg="black",fg="white")
...
def bpavail():
    ...
    try:
        ...
        messagebox.showerror("Error","Unable to show available blood packets!",parent=bpa)
    finally:
        conn.commit()
        c.close()
        conn.close()
...
b1=Button(fl,text="NEW DONOR",font='helvetica',height=2,width=40,command=newdonor,fg='#FCFF33',bg='black')
b1.grid(row=0,column=1,padx=100,pady=10)
b2=Button(fl,text="DONORS LIST",font='helvetica',height=2,width=40,command=dlist,fg='#FCFF33',bg='black')
b2.grid(row=1,column=1,padx=100,pady=10)
b3=Button(fl,text="SEARCH DONOR",font='helvetica',height=2,width=40,command=searchdonor,fg='#FCFF33',bg='black')
b3.grid(row=2,column=1,padx=100,pady=10)
b4=Button(fl,text="NEW BUYER",font='helvetica',height=2,width=40,command=sbp,fg='#FCFF33',bg='black')
b4.grid(row=3,column=1,padx=100,pady=10)
b5=Button(fl,text="BUYERS LIST",font='helvetica',height=2,width=40,command=blist,fg='#FCFF33',bg='black')
b5.grid(row=4,column=1,padx=100,pady=10)
b6=Button(fl,text="SEARCH BUYER",font='helvetica',height=2,width=40,command=searchbuyer,fg='#FCFF33',bg='black')
b6.grid(row=5,column=1,padx=100,pady=10)
b7=Button(fl,text="BLOOD PACKETS IN STOCK",font='helvetica',height=2,width=40,command=bpavail,fg='#FCFF33',bg='black')
b7.grid(row=6,column=1,padx=100,pady=10)
b8=Button(fl,text="EXIT",font='helvetica',height=2,width=15,command=exitgui,fg='#FCFF33',bg='black')
